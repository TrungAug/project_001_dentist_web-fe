app.controller('AdminListAppoinment', function ($scope, $http, $rootScope, $location, $timeout, TimezoneService, $route) {
    ...
    $scope.updateStatus = (appointment, statusId) => {
        ...
        $scope.originalStatusId = appointment.appointment.appointmentStatus.appointment_StatusId
                    ...
                    Swal.fire({
                        ...
                        if (rs.dismiss === Swal.DismissReason.cancel) {
                            $scope.$apply(function() {
                                appointment.appointment.appointmentStatus.appointment_StatusId = $scope.originalStatusId;
                            })
                        } else 
                        if (rs.isConfirmed) {
                            var isDeleted = true
