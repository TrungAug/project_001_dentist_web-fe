app.controller('AdminListAppoinment', function ($scope, $http, $rootScope, $location, $timeout, TimezoneService, $route) {
    ...
    $scope.updateStatus = (app, statusId) => {
        console.log("appointment update", app);
        console.log("statusId update",statusId);
        //console.log(" $scope.listAppointmentStatusBD update", $scope.listAppointmentStatusBD);
        const originalStatus = $scope.listAppointmentStatusBD.find(s => s.status === app.appointment.appointmentStatus.status)
        ...
        //                         $scope.a.appointment.appointmentStatus.appointment_StatusId = originalStatusId
        //                     })
        //                 } else 
        //                 if (rs.isConfirmed) {
        //                     var isDeleted = true
