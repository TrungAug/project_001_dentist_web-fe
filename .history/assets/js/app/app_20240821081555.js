...
app.config(function ($routeProvider) {
    $routeProvider
        ...
        .when("/admin", {
            ...
            data: { title: 'Dashboard', requiresAuth: true, roles: [''] }
        })
        ...
        .when("/admin/my-profile", {
            ...
            data: { title: 'Hồ sơ của tôi', requiresAuth: true, roles: [''] }
        })
        .when("/admin/my-setting", {
            templateUrl: "templates/admin-my-setting.html",
            data: { title: 'Cài đặt', requiresAuth: true, roles: [''] }
        })
        .when("/admin/post", {
            templateUrl: "templates/admin-post.html",
            data: { title: 'Bài viết', requiresAuth: true, roles: [''] }
        })
        .when("/admin/transaction-success", {
            templateUrl: "templates/transaction-success.html",
            data: { title: 'Thanh toán thành công', requiresAuth: true, roles: [''] }
        })
        .when("/not-found", {
