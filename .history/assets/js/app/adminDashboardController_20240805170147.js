    ...
    var areachart, areaChartOptions = {
      ...
      xaxis: {
        ...
        labels: {
          ...
          tickPlacement: 'on', // Đảm bảo các ngày được phân phối đều trên trục x
          min: $scope.getCategories()[0], // Đặt giá trị tối thiểu cho trục x
          max: $scope.getCategories().slice(-1)[0],
          show: !0,
          trim: !1,
          minHeight: void 0,
          maxHeight: 120,
