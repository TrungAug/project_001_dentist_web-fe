app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route, convertMoneyService) {
    ...
    $scope.getPrescriptionWithMedicinesByAppointment = (appointmentId) => {
        ...
        $http.get(url + '/prescription-by-appointment', { params: params }).then(response => {
            ...
            console.log("$scope.listPrescriptionByAppointmentAndMedicinesDB",$scope.listPrescriptionByAppointmentAndMedicinesDB);
        })
    }
    ...
    $scope.getPrescriptionByAppointment = (appointment, listPrescriptionByAppointmentAndMedicinesDB) => {
        ...
        let prescription = listPrescriptionByAppointmentAndMedicinesDB.filter(item => item.prescription.appointmentPatientRecord.appointmentPatientRecordId === aprId)
        console.log("prescription", prescription);
        //console.log("listPrescriptionByAppointmentAndMedicinesDB",listPrescriptionByAppointmentAndMedicinesDB);
        return prescription
    }
