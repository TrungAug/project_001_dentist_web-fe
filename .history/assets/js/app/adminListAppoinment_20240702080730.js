app.controller('AdminListAppoinment', function ($scope, $http, $rootScope, $location, $timeout, TimezoneService, $route) {
    ...
    $scope.updateStatus = (appointment, statusId) => {
        ...
        const originalStatusId = appointment.appointment.appointmentStatus.appointment_StatusId
                    ...
                    Swal.fire({
                        ...
                        if (rs.dismiss === Swal.DismissReason.cancel) {
                            $scope.$apply(function() {
                                appointment.appointment.appointmentStatus.appointment_StatusId = originalStatusId;
                            })
                        } else 
                        if (rs.isConfirmed) {
                            var isDeleted = true
