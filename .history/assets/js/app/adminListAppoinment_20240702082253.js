app.controller('AdminListAppoinment', function ($scope, $http, $rootScope, $location, $timeout, TimezoneService, $route) {
    ...
    $scope.updateStatus = (app, statusId) => {
        ...
        const originalStatusId = app.appointment.appointmentStatus.appointment_StatusId
                    ...
                    Swal.fire({
                        ...
                        if (rs.dismiss === Swal.DismissReason.cancel) {
                            $scope.$apply(function() {
                                angular.copy(originalStatusId, appointment.appointmentStatus.appointment_StatusId);
                            })
                        } else 
                        if (rs.isConfirmed) {
                            var isDeleted = true
