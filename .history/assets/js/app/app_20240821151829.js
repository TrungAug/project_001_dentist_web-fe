...
app.config(function ($routeProvider) {
    $routeProvider
        ...
        .when("/admin", {
            ...
            data: { title: 'Dashboard', requiresAuth: false, roles: ['QUAN_LY'] }
        })
        ...
        .when("/admin/my-profile", {
            ...
            data: { title: 'Hồ sơ của tôi', requiresAuth: false, roles: ['ADMIN'] }
        })
        .when("/admin/my-setting", {
            templateUrl: "templates/admin-my-setting.html",
            data: { title: 'Cài đặt', requiresAuth: false, roles: ['ADMIN'] }
        })
        .when("/admin/post", {
            templateUrl: "templates/admin-post.html",
            data: { title: 'Bài viết', requiresAuth: false, roles: ['ADMIN'] }
        })
        .when("/admin/transaction-success", {
            templateUrl: "templates/transaction-success.html",
            data: { title: 'Thanh toán thành công', requiresAuth: false, roles: ['ADMIN'] }
        })
        .when("/not-found", {
