app.controller('AdminCreateAccountController', function ($scope, $http, $rootScope, $location, $timeout, API, $route, adminBreadcrumbService, processSelect2Service) {
    ...
    //cần kiểm tra sự tồn tại của tài khoản nếu đã có thì loại khỏi danh sách
    $scope.checkUserByAnObject = (params) => {
        // let params = params || {};
        $http.get(url + '/check-exist-user-by-object',params).then(response => {
