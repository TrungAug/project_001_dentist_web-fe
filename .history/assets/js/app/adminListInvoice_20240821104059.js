app.controller('AdminListInvoice', function ($scope, $http, $rootScope, $location, $timeout, TimezoneService, $route, API, adminBreadcrumbService, processSelect2Service) {
    ...
    $scope.createBill=()=>{
        if($scope.selectedAppointmentId=='undefined'){
            Swal.fire({
                title: "Cảnh báo!",
                html: '<p class="text-danger">Vui logf chịn thông tin khách hàng!</p>',
                icon: "error"
            })
            return
        }
        console.log("$scope.selectedAppointmentId",$scope.selectedAppointmentId);
    }
