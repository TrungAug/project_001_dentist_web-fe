...
app.controller('AdminPatientRecord', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.exportPDF = () => {
        ...
        document.fonts.ready.then(() => {
            ...
            console.log("pdfContent element:", pdfContent);
            console.log("pdfContent dimensions:", pdfContent.offsetWidth, pdfContent.offsetHeight);
            console.log("pdfContent visibility:", window.getComputedStyle(pdfContent).visibility);
            console.log("pdfContent display:", window.getComputedStyle(pdfContent).display);
