...
app.config(function ($routeProvider) {
    $routeProvider
        ...
        .when("/admin", {
            ...
            data: { title: 'Dashboard', requiresAuth: false, roles: ['ADMIN'] }
        })
