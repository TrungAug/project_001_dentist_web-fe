app.controller('AdminDashboardController', function ($scope, $http, $rootScope, $location, API, adminBreadcrumbService, $timeout, processSelect2Service) {
  ...
  $scope.initData = () => {
    ...
    $scope.growthPercentageMonth = $scope.getRevenueGrowthComparison(null, moment().subtract(1, 'months').month().toString(), null)
    $scope.growthPercentageYear = $scope.getRevenueGrowthComparison(null,null, moment().subtract(1, 'years').year().toString())
