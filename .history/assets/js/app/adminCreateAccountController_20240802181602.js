    ...
    $scope.createAccount = () => {
        ...
        if (checkForm) {
            ...
            $scope.mailInfo = {
                ...
                body: '<p>Chúc mừng bạn đã tạo tại khoản thành công tại nha khoa Tooth Teeth.</p> <p>Mật khẩu của bạn là: ' +'<span class="badge bg-info">'+ $scope.accForm.password +'</span>'+'</p>'
            }
