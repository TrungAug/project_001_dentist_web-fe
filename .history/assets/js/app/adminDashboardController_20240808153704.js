  ...
  $scope.fetchListAppointmentByYear = (dateString) => {
    ...
    Promise.all([
      ...
      if(currentYearData.length!=0){
       // $scope.appointmentConversionRate=($scope.listCompletedAppointments.length/currentYearData.length)*100
        
        $scope.appointmentConversionRate= $scope.calculateGrowthPercentage($scope.listCompletedAppointments.length,currentYearData.length)
        console.log("$scope.appointmentConversionRate",$scope.appointmentConversionRate);
      }
