app.controller('AdminDoctorController', function ($scope, $http, $rootScope, $location, $timeout,API) {
    ...
    $scope.urlImg = (filename) => {
        console.log("url+ filename",url+"/image/imgDoctor/" + filename);
        return url+"/image/imgDoctor/" + filename;
    }
    ...
    $scope.uploadImg = (files) => {
        ...
        $http.post(url + "/saveImage/imgDoctor", form, {
        ...
        console.log("$scope.filenames post",$scope.filenames);
    }
