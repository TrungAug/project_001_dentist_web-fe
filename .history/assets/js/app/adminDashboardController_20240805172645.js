  ...
  $scope.chartArea = function () {
    var areachart, areaChartOptions = {
      series: [
        {
          name: "Doanh thu",
          data: [31000000, 28000000, 30000000, 51000000, 42000000, 109000000, 100000000, 31000000, 40000000, 28000000, 31000000, 58000000, 30000000, 51000000, 42000000, 109000000, 100000000, 116000000, 40000000, 28000000, 31000000, 58000000, 30000000, 51000000, 42000000, 109000000, 100000000, 116000000, 0, 9000000, 10000000, 69000000]
        }
      ...
      xaxis: {
        ...
        tickAmount: $scope.getCategories().length,
        tickPlacement: 'on',
        //min: moment().startOf('month').toDate().getTime(),
        max: moment().endOf('month').toDate().getTime(),
        axisBorder: {
          show: !1
        },
        tooltip: {
      ...
      yaxis: {
        labels: {
          ...
          max: 150000000, // Giá trị cao nhất (150 triệu đồng)
          tickAmount: 16,
          formatter: function (value) {
            if (value === undefined || value === null) {
              return '0.00 triệu đồng'; 
            }
            const millionValue = value / 1000000;
            return `${millionValue.toFixed(2)} triệu đồng`;
          },
          show: !0,
          trim: !1,
          offsetX: -10,
