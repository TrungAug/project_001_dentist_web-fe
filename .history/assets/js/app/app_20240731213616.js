...
app.config(function ($routeProvider) {
    $routeProvider
        ...
        .when("/admin/dental-supplies", {
            ...
            data: { title: 'Quản lí vật tư nha khoa' }
        })
        ...
        .when("/admin/distribution-supplies", {
            ...
            data: { title: 'Quản lí Nhà phân phối' }
        })
        ...
        .when("/admin/list-invoice", {
            ...
            data: { title: 'Quản lý các hóa đơn' }
        })
...
app
    ...
    .service('adminBreadcrumbService', function($location, $route) {    
        ...
        this.generateBreadcrumb = function() {
          ...
          breadcrumbSec.empty(); 
          breadcrumbSec.append(`<li class="breadcrumb-item"><a href="#">Trang chủ</a></li>`);
          breadcrumbSec.append(`<li class="breadcrumb-item active" aria-current="page"><a href="#!` + currentUrl + `">` + pageTitle + `</a></li>`);
        };
      });
app
