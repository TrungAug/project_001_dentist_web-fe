    ...
    $scope.processDoctorUnavailabilityAllDoctor = () => {
        return new Promise((resolve, reject) => {
            ...
            Promise.all([
                ...
                if ($scope.isReExaminationFilter) {
                    combinedData = combinedData.filter(item =>                        
                        item.appointment && item.appointment.appointmentPatientRecord &&
                        item.appointment.appointmentPatientRecord.reExamination != "" || item.appointmentPatientRecord &&
                        item.appointmentPatientRecord.reExamination != ""
                    );
