app.controller('AdminMyProfileController', function ($scope, $http, $rootScope, $location, $timeout, API, $route, adminBreadcrumbService, processSelect2Service) {
    ...
    $scope.patternPassword = async (password) => {
        ...
        await $scope.checkSamePreviousPassword(password)
       
        console.log("$scope.isPatternPassword",$scope.isPatternPassword);
        console.log("$scope.isSamePreviousPassword",$scope.isSamePreviousPassword);
        
        console.log("$scope.isValid",!$scope.isSamePreviousPassword&&$scope.isPatternPassword);
