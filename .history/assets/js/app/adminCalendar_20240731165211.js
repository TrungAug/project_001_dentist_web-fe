app.controller('AdminCalendar', ['breadcrumbs',function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route, convertMoneyService,API,breadcrumbs) {
