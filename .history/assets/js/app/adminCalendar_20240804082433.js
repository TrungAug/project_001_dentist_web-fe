    ...
    $scope.initializeUIComponents = () => {
        ...
        $('#appointmentType').on('change', function () {
            $timeout(function () {
                ...
                $scope.getAppointmentType=$scope.listAppointmentTypeDB.filter(item => item.appointment_TypeId === $scope.formApp.appointmentTypeId)[0].typeName.toUpperCase()==='TÁI KHÁM'
