app.controller('AdminDoctorCalendarController', function ($scope, $http, $rootScope, $location, $timeout, $window, processSelect2Service, TimezoneService, $route, API, adminBreadcrumbService) {
    ...
    $scope.isShowService = () => {
        return $scope.selecteTreatments.length > 0
    }
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventClick: function (arg) {
                    ...
                    if(checkCurrentCodition!=""&&checkCurrentCodition!=null){
                        console.log("originalApp.appointmentPatientRecord.currentCodition",originalApp.appointmentPatientRecord.currentCodition);
                    }
                    // $scope.originalCodition=originalApp.appointmentPatientRecord.currentCodition!=""?originalApp.appointmentPatientRecord.currentCodition.split(", "):""
