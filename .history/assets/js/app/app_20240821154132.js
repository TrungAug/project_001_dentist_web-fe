...
app.config(function ($routeProvider) {
    $routeProvider
        ...
        .when("/admin", {
            ...
            data: { title: 'Dashboard', rrequiresAuth: true, roles: ['QUAN_LY'] }
        })
        ...
        .when("/admin/my-profile", {
            ...
            data: { title: 'Hồ sơ của tôi', rrequiresAuth: true, roles: ['ADMIN'] }
        })
        .when("/admin/my-setting", {
            templateUrl: "templates/admin-my-setting.html",
            data: { title: 'Cài đặt', rrequiresAuth: true, roles: ['ADMIN'] }
        })
        .when("/admin/post", {
            templateUrl: "templates/admin-post.html",
            data: { title: 'Bài viết', rrequiresAuth: true, roles: ['ADMIN'] }
        })
        .when("/admin/transaction-success", {
            templateUrl: "templates/transaction-success.html",
            data: { title: 'Thanh toán thành công', rrequiresAuth: true, roles: ['ADMIN'] }
=======
            data: { title: 'Hồ sơ của tôi', requiresAuth: false, roles: ['HANH_CHINH'] }
        })
        .when("/admin/my-setting", {
            templateUrl: "templates/admin-my-setting.html",
            data: { title: 'Cài đặt', requiresAuth: false, roles: ['HANH_CHINH'] }
        })
        .when("/admin/post", {
            templateUrl: "templates/admin-post.html",
            data: { title: 'Bài viết', requiresAuth: false, roles: ['HANH_CHINH'] }
        })
        .when("/admin/transaction-success", {
            templateUrl: "templates/transaction-success.html",
            data: { title: 'Thanh toán thành công', requiresAuth: false, roles: ['HANH_CHINH'] }
>>>>>>> 60eca27317881aaa73edf0296cf31327a4375b24
        })
        .when("/not-found", {
        ...
        function subscribeToChannels() {
            ...
            if (userType === 'HANH_CHINH') {
                stompClient.subscribe('/chatroom', function (message) {
                    ...
                    // Handle the user status change message
                });
