    ...
    $scope.initializeUIComponents = () => {
        ...
        $('#abnormalityId').on('change', function () {
            $timeout(function () {
                ...
                console.log("$scope.selectedAbnormalityId", $scope.selectedAbnormalityId);
    ...
    $scope.crudCTResult = () => {
        ...
        $scope.getOriginalData = (appointmentId) => {
            ...
            let getOriginalCtresultAbnormalityPromise = $http.get(url + '/ct-result-abnormality-by-appointmnet-id/' + appointmentId, { headers: headers }).then((response) => {
                ...
                console.log(" $scope.originalCtresultAbnormality", $scope.originalCtresultAbnormality);
        ...
        $scope.editCTResult = (cs, $event) => {
            console.log("Cs", cs);
            console.log("cs.appointment.appointmentId",cs.appointment.appointmentId);
            ...
            if (cs != null) {
               ...
               // $('#appointmentId').val(cs.appointment.appointmentId).trigger('change');
               $scope.formCTResult.appointmentId=cs.appointment.appointmentId
        ...
        $scope.updateCTResult = async () => {
            ...
            if (valid) {
                ...
                console.log("reqCTRSData",reqCTRSData);
