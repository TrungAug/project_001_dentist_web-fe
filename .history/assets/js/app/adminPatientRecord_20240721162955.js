...
app.controller('AdminPatientRecord', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.exportPDF = () => {
        document.fonts.ready.then(() => {
            ...
            const originalVisibility = pdfContent.style.visibility;
            const originalPosition = pdfContent.style.position;
            const originalLeft = pdfContent.style.left;
    
            // Make the element visible and position it on-screen
            ...
            console.log("Modified pdfContent dimensions:", pdfContent.offsetWidth, pdfContent.offsetHeight);
            ...
            setTimeout(() => {
                html2canvas(pdfContent, {
                    ...
                    pdfContent.style.visibility = originalVisibility;
