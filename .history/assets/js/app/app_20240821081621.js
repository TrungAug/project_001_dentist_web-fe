...
app.config(function ($routeProvider) {
    $routeProvider
        ...
        .when("/admin", {
            ...
            data: { title: 'Dashboard', requiresAuth: false, roles: [''] }
        })
        ...
        .when("/admin/my-profile", {
            ...
            data: { title: 'Hồ sơ của tôi', requiresAuth: false, roles: [''] }
        })
        .when("/admin/my-setting", {
            templateUrl: "templates/admin-my-setting.html",
            data: { title: 'Cài đặt', requiresAuth: false, roles: [''] }
        })
        .when("/admin/post", {
            templateUrl: "templates/admin-post.html",
            data: { title: 'Bài viết', requiresAuth: false, roles: [''] }
        })
        .when("/admin/transaction-success", {
            templateUrl: "templates/transaction-success.html",
            data: { title: 'Thanh toán thành công', requiresAuth: false, roles: [''] }
        })
        .when("/not-found", {
...
app.service('SocketService', function ($q) {
    let socket;
    let stompClient;
    ...
    function subscribeToChannels() {
        ...
        if (userType === 'LE_TAN') {
            stompClient.subscribe('/user/chatroom', function (message) {
                console.log('User Status Change: ' + message.body);
