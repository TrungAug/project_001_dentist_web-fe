...
app.config(function ($routeProvider) {
    $routeProvider
        ...
        .when("/admin/list-appoinment", {
            ...
            data: { title: 'Danh sách cuộc hẹn', requiresAuth: true, roles: ['QUAN_LY','HANH_CHINH'] }
        })
        ...
        .when("/admin/create-account", {
            ...
            data: { title: 'Tài khoản', requiresAuth: true,}
        })
        ...
        .when("/admin/my-profile", {
            ...
            data: { title: 'Hồ sơ của tôi', requiresAuth: true, roles: ['ADMIN'] }
        })
        .when("/admin/my-setting", {
            templateUrl: "templates/admin-my-setting.html",
            data: { title: 'Cài đặt', requiresAuth: true, roles: ['ADMIN'] }
        })
        .when("/admin/post", {
            templateUrl: "templates/admin-post.html",
            data: { title: 'Bài viết', requiresAuth: true, roles: ['ADMIN'] }
        })
        .when("/admin/transaction-success", {
            templateUrl: "templates/transaction-success.html",
            data: { title: 'Thanh toán thành công', requiresAuth: true, roles: ['ADMIN'] }
        })
        .when("/not-found", {
