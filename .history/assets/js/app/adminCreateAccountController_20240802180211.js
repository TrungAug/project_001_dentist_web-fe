    ...
    $scope.createAccount = () => {
        ...
        if (checkForm) {
            ...
            $scope.mailInfo={
                ...
                body:'Chúc mừng bạn đã tạo tại khoản thành công tại nha khoa Tooth Teeth. Mật khẩu của bạn là: '+$scope.accForm.password
            }

            //post vào bảng accout
            // gửi email cho người dùng
            let accRequest = $http.post(url + '/register', $scope.accForm)
           // let emailRequest =$http.post(url + '/sendmail', $scope.accForm)
