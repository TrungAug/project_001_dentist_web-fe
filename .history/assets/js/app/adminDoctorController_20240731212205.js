app.controller('AdminDoctorController', function ($scope, $http, $rootScope, $location, $timeout, API, $route) {
    ...
    $scope.generateBreadcrumb = () => {
        ...
        $scope.pageTitle = getTitleForUrl(currentUrl)
        breadcrumbSec.prepend(`<li class="breadcrumb-item"><a href="#">Trang chủ</a></li>`)
        breadcrumbSec.append(`<li class="breadcrumb-item"><a href="#!`+currentUrl+`">`+$scope.pageTitle+`</a></li>`)
