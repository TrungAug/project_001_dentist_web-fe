    ...
    $scope.initializeUIComponents = () => {
        ...
        $('#appointmentType').on('change', function () {
            $timeout(function () {
                ...
                $scope.getAppointmentType=$scope.listAppointmentTypeDB.filter(item => item.appointment_TypeId === $scope.formApp.appointmentTypeId)
                console.log("$scope.getAppointmentType",$scope.getAppointmentType[0].typeName.toUpperCase()==='TÁI KHÁM');
            });
        });
