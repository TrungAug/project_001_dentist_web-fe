    ...
    $scope.initializeUIComponents = () => {
        ...
        $('#appointmentType').on('change', function () {
            $timeout(function () {
                ...
                // $scope.getAppointmentType=$scope.listAppointmentTypeDB.filter(item => item.appointmentTypeId === $scope.formApp.appointmentTypeId)
                // console.log("$scope.getAppointmentType",$scope.getAppointmentType);
            });
        });
