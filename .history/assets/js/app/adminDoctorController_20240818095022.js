        ...
        $scope.createDoctor = () => {
            ...
            if (valid) {
                ...
                $http.post(url + '/doctor', requsetDoctorJSON, { headers: headers }).then(respone => {
                    ...
                    var resquestCloudinary= $http.post(url + "/upload-image-cloudinary", formData, {
                    ...
                    Promise.all([request1, request2,resquestCloudinary])
                        .then(([request1, request2,resquestCloudinary]) => {
                            console.log("resquestCloudinary",resquestCloudinary.data);
