app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route, convertMoneyService) {
    ...
    $scope.getPrescriptionByAppointment = (appointmentId,listPrescriptionByAppointmentAndMedicinesDB) => {
        let prescription = listPrescriptionByAppointmentAndMedicinesDB.filter(prescription => bill.appointment.appointmentId === appointmentId)
        return listPrescriptionByAppointmentAndMedicinesDB
    }
